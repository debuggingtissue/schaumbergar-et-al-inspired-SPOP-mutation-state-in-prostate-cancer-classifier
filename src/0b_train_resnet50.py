...
if __name__ == '__main__':
    ...
    ensembles_count = 1
    model_count_in_each_ensemble = 3 #must be odd number to avoid tie
    ensembles = ensemble_manager.generate_ensembles(ensembles_count, model_count_in_each_ensemble, data_manager)

    test_manager = test_manager.TestManager(data_paths.TEST_DATA_PATH, ensembles)
    test_manager.get_predictions()
